...
// Product Arrays
const shoeProducts = [shoe1, shoe2, shoe3, shoe4, shoe5].map((image, index) => ({
  id: `shoe-${index + 1}`,
...
const sneakerProducts = [sneaker1, sneaker2, sneaker3, sneaker4].map((img, i) => ({
  id: `sneaker-${i + 1}`,
...
const productmwItems = [
  productmw1, productmw2, productmw3, productmw4, productmw5,
  productmw6, productmw7, productmw8, productmw9, productmw10
].map((img, i) => ({
  id: `mw-${i + 1}`,
...
const bagProducts = [bag1, bag2, bag3, bag4, bag5].map((img, i) => ({
  id: `bag-${i + 1}`,
  brand: `Bag Brand ${i + 1}`,
  name: `Bag Style ${i + 1}`,
  image: img,
...
const accessories = [
  ...
  { id: "FA8", image: FA8, brand: "Yiwu", name: "Stainless steel knuckle ring", price: 3000, rating: 5 },
...
const techProducts = [
  { id: "tech-1", image: earpodwireless, brand: "Samsung", name: "Earpod Wireless", price: 12000 },
  { id: "tech-2", image: headphones, brand: "Oraimo", name: "Headphone M2", price: 8000 },
  { id: "tech-3", image: JBLspeaker, brand: "iPhone", name: "Wired Earpiece", price: 3000 },
  { id: "tech-4", image: powerbank, brand: "Oraimo", name: "20,000 mAh Powerbank", price: 25000 },
  { id: "tech-5", image: cameralensprotector, brand: "iPhone", name: "Camera Lens Protector", price: 14500 },
  { id: "tech-6", image: applewatchseries9, brand: "Apple", name: "Relógio Smartwatch", price: 50000 },
  { id: "tech-7", image: amazonmouse, brand: "Amazon", name: "Itel Mousepad", price: 10500 },
  { id: "tech-8", image: phonecase1, brand: "Shangu", name: "iPhone 11 Pro Phone Case", price: 5000 },
];
